...
<?
$pagetitle = "TravNow - The Best Deals On Hotels, Vacation Rentals, Condo/Timeshare Rentals, & More!"; 
$desc = "Discover unbelievable deals on hotels, vacation rentals, condo/timeshare rentals, and other unique properties with Travnow!";
...
<? include ("inc/header.php"); ?>
 ...
 <? include ('inc/video_div.php'); ?>

                    </div>
                </div>
                <!-- /Caption-->
<? 
include('inc/complete_widget.php'); 
?>
