<?
 ...
 $input_ci= date('Y-m-d', strtotime('+25 days'));
 $input_co= date('Y-m-d', strtotime('+29 days'));
$nights = '4';
$deal = '3';
...
echo "</pre>";
*/
$delete = mysqli_query($con, "DELETE FROM vegas_deals WHERE dealnum='$deal' ") or die ('Unable to execute query. '. mysqli_error($con));
...
$feat = mysqli_query($con, "INSERT INTO vegas_deals (id, propid, name, rating, thumb, publicprice, price, promoprice, pricediff, bigsave, checkin, checkout, timestamp, refundable,dealnum,nights) VALUES ('NULL', '$propid', '$propname2','$propstars','$thumb','$publicprice','$price','$promoprice','$pricediff','$bigsave','$CheckIn','$CheckOut', NOW(), '$refundable','$deal','$nights')") or die ('Unable to execute query. '. mysqli_error($con));
