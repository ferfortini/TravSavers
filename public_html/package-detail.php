...
<main class="detailPage">
    ...
    <div id="actual-content" style="display: none;">
            ...
            <div class="container">
                <div class="detailPage-left">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h1 class="detailPage-title text-primary" id="package-name"></h1>
                            <div class="" id="package-description"></div>
                            <ul class="detailInfo-list list-unstyled mt-4" id="include-perks">
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- <div class="col-md-12 text-center pt-md-4 pt-2 d-flex gap-2 justify-content-center flex-wrap">
                                <button type="button" class="btn btn-primary" id="book-resort-preview"></button>
                                <button type="button" class="btn btn-outline-primary" id="book-travsaver"></button>
                            </div> -->
                        </div>
                    </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="guestModal" tabindex="-1" role="dialog" data-bs-backdrop="static" aria-labelledby="guestModalLabel"
            aria-hidden="true">
...
<script src="assets/js/frontend/package-details.js"></script>