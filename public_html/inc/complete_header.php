...
<body class="vh-100 vw-100 overflow-hidden">
            ...
            <div class="container">
                <!-- Brand -->
                 <a class="navbar-brand d-inline-flex align-items-center" id="brandHeader" href="/">
                    <img src="/assets/img/travsav_logo_all.png" class="logo" alt="TravSavers - Save Big On Hotel, Attraction, and Vacation Packages!" style="max-width:150px; position:relative; top:-5px;">
 ...
 <!-- /Sub Links -->
                ...
                <div class="ms-0 ms-xl-8 ms-auto">
                        ...
                        <span class='fs-5'><i class='ti ti-phone'></i></span>
                        <span>(866) 540-8956</span>
