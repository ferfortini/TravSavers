            ...
            <div class="container">
                <!-- Brand -->
                 <a class="navbar-brand d-inline-flex align-items-center" id="brandHeader" href="/">
                    <img src="/assets/img/travsav_logo.jpg" class="logo" alt="TravSavers - Save Big On Hotel, Attraction, and Vacation Packages!" style="max-width:150px; position:relative; top:-5px;">
